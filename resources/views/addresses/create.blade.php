    ...
    <form action="{{ $address ? route('addresses.update', $address) : route('addresses.store') }}" method="POST" class="space-y-6">
        ...
        <div class="glass p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <label class="flex items-center gap-3 p-3 rounded-lg border-2 {{ old('address_type', $address?->address_type) === 'home' ? 'border-indigo-500 bg-indigo-500/10' : 'border-white/10 hover:border-white/20' }} cursor-pointer transition">
